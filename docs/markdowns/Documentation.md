...
Branch Studio does not touch a Branch 1 runtime until you press **Update**. Existing ProfileStore saves load unchanged as long as `Data.Start` uses the same `Store` name.
